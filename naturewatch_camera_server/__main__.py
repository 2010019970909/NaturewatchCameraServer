...
# TODO: instantiate the logger here,
# so that it can be used here and in the app.
# probably need to pass it to the app and
# to fetch the config for the log file path.
...
#     # inspired by https://stackoverflow.com/questions/58250817/
# raspberry-pi-camera-module-check-if-connected#comment102874971_58250817
...
#     result_text = [
# parameter for parameter in result_text if '=' in parameter]
